...
class PipewireNode {
 public:
  ...
  std::string unique_id() { return unique_id_; }
  std::string model_id() { return model_id_; }
  std::vector<VideoCaptureCapability> capabilities() { return capabilities_; }
...
class PipewireSession : public rtc::RefCountedNonVirtual<PipewireSession> {
 public:
  ...
  rtc::scoped_refptr<VideoCaptureModule> CreateDevice(
      const char* deviceUniqueIdUTF8);
  VideoCaptureModule::DeviceInfo* CreateDeviceInfo();
  ...
  std::deque<PipewireNode>& nodes() { return nodes_; }
